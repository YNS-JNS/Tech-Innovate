    ...
    return (
        <div className="relative my-12 flex w-full flex-col items-center sm:mt-24">
            <a
                ...
                target="_blank"
                rel="noreferrer"
                className="mx-auto flex max-w-fit items-center justify-center space-x-2 overflow-hidden rounded-full bg-white px-7 py-2 transition-all hover:bg-blue-200"
            >
                <svg
            ...
            <p className="mt-3 rounded border px-3 py-1 shadow">
                🎁 <span className="text-accent font-semibold">$50 off</span> for the first 1,000 customers!
            </p>
