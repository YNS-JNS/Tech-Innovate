...
const Portfolio: React.FC = () => {
  return (
    <div className="relative overflow-hidden bg-stone-950 pt-12 pb-32 space-y-24">
                ...
                <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-pink-500">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    ...
                    <path strokeLinecap="round" strokeLinejoin="round"
                      d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2 2.25v6.75a2.25 2.25 0 002.25 2.25z">
                    </path>
                  </svg>
                </span>
              </div>
